...
var ExchangePair = /** @class */ (function () {
    function ExchangePair(web3, metaData) {
        ...
        this.tokenBalanceReserve = function () { return _this.contract.methods.tokenBalnaceReserver().call().then(web3_utils_1.toBN); };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [2 /*return*/, caller.send({
                            from: options.from,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, token.methods.allowance(options.from, this.metaData.pairContract).call().then(web3_utils_1.toBN).catch()];
                    case 2:
                        allowanced = _a.sent();
                        if (!allowanced) {
