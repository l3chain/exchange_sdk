...
exports.ExchangeTransactionBuilder = exports.ExchangeBalanceTransactionSender = exports.ExchangeBorrowTransactionSender = exports.ExchangeTransactionErrors = exports.ExchangeTransactionBuilderEmitter = void 0;
...
var ExchangeTransactionSender = /** @class */ (function (_super) {
    ...
    function ExchangeTransactionSender() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ExchangeTransactionSender;
}(ExchangeTransactionBuilderEmitter));
var ExchangeBorrowTransactionSender = /** @class */ (function (_super) {
    __extends(ExchangeBorrowTransactionSender, _super);
    function ExchangeBorrowTransactionSender(exchangeRouter, signerProvider, payload, options) {
        ...
        _this.senderOptions = options;
        var web3 = new web3_1.default(signerProvider);
        var compments = exchangeRouter.getComponents(fromETID.chainIdentifier.toChainName());
        if (!compments) {
            throw new Error("ETSender: InvaildFromChainIdentifier");
        }
        var factoryAddress = compments.factory._address;
        var factory = new web3.eth.Contract(abi_1.ABI.Factory, factoryAddress);
        _this.loader = Promise.all([
            factory.methods.pairOf(fromETID.tokenContract).call(),
            ...
            var pairAddress, coinBalance, fees, pair, borrowAmountBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pairAddress = rets[0], coinBalance = rets[1], fees = rets[2];
                        pair = new web3.eth.Contract(abi_1.ABI.Pair, pairAddress);
                        return [4 /*yield*/, pair.methods.borrowAmountOf(fromAccount).call().then(web3_utils_1.toBN)];
                    case 1:
                        borrowAmountBalance = _a.sent();
                        console.log(amount.toString());
                        if (borrowAmountBalance.lt(amount)) {
                            this.emit("error", exports.ExchangeTransactionErrors.INSUFFICIENT_BORROW_AMOUNT_BALANCE);
                            return [2 /*return*/];
                        }
    ...
    ExchangeBorrowTransactionSender.prototype.call = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.exchangeCaller.estimateGas(this.exchangeParams)];
                    case 2:
                        gas = _a.sent();
                        this.emit('estimateGas', (0, web3_utils_1.toNumber)(gas));
                        return [2 /*return*/, this.exchangeCaller.call(__assign(__assign({}, this.exchangeParams), { gasPrice: this.senderOptions.gasPrice, gas: Math.floor((0, web3_utils_1.toNumber)(gas) * this.senderOptions.gasMultiple) }))];
                }
            });
        });
    };
    ExchangeBorrowTransactionSender.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            var gas;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        gas = _a.sent();
                        this.emit('estimateGas', (0, web3_utils_1.toNumber)(gas));
                        return [2 /*return*/, this.exchangeCaller.send(__assign(__assign({}, this.exchangeParams), { gasPrice: this.senderOptions.gasPrice, gas: Math.floor((0, web3_utils_1.toNumber)(gas) * this.senderOptions.gasMultiple) }))
    ...
    return ExchangeBorrowTransactionSender;
}(ExchangeTransactionSender));
exports.ExchangeBorrowTransactionSender = ExchangeBorrowTransactionSender;
var ExchangeBalanceTransactionSender = /** @class */ (function (_super) {
    __extends(ExchangeBalanceTransactionSender, _super);
    function ExchangeBalanceTransactionSender(exchangeRouter, signerProvider, payload, options) {
        if (options === void 0) { options = { gasPrice: undefined, gasMultiple: 1.2 }; }
        var _this = _super.call(this) || this;
        _this.senderOptions = options;
        var fromETID = payload.fromETID, fromAccount = payload.fromAccount, toETID = payload.toETID, toAccount = payload.toAccount, amount = payload.amount;
    ...
    ExchangeBalanceTransactionSender.prototype.call = function () {
        return __awaiter(this, void 0, void 0, function () {
            var gas;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ExchangeBalanceTransactionSender.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            var approveTx, gas;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    return ExchangeBalanceTransactionSender;
}(ExchangeTransactionSender));
exports.ExchangeBalanceTransactionSender = ExchangeBalanceTransactionSender;
var ExchangeTransactionBuilder = /** @class */ (function (_super) {
    ...
    function ExchangeTransactionBuilder(router, props) {
        var _this = _super.call(this) || this;
        _this.isUseBorrowAmount = false;
        var fromAccount = props.fromAccount, fromChain = props.fromChain;
        var compments = router.getComponents(fromChain);
        if (!compments) {
    ...
    ExchangeTransactionBuilder.prototype.build = function (signerProvider, options) {
        ...
        return this.isUseBorrowAmount
            ? new ExchangeBorrowTransactionSender(this.router, signerProvider, this.payload, options)
            : new ExchangeBalanceTransactionSender(this.router, signerProvider, this.payload, options);
    };
