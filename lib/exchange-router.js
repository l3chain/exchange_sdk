...
var exchange_builder_1 = require("./exchange-builder");
var ExchangeRouter = /** @class */ (function () {
    ...
    //     })
    // }
    function ExchangeRouter(l3, props) {
        var _this = this;
        this.getCompments = function (chainName) {
         ...
         * @returns rate 百分比
         */
        this.feeAdditionalOf = function (pairOrETID) { return new Promise(function (resolve) {
            ...
            _this._chains[args.chainIdentifier.toChainName()].factory.methods
         ...
         * @returns
         */
        this.supportExchangePairs = function (fromChain) { return _this.metaDatas.filter(function (data) { return data.etid.chainIdentifier.toLowerCase() == sdk_1.ChainIdentifiers[fromChain].toLowerCase(); }).map(function (data) { return new exchange_pair_1.ExchangePair(_this._chains[fromChain].web3, data); }); };
        /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._chains[onChain].client.query(gql).then(function (data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, this.selectExchangeHistory(history.to.chainIdentifier.toChainName(), {
                            first: 1,
                            where: {
         ...
         * @param account
         */
        this.selectBorrowAmountsOf = function (fromChain, filter) {
            var gql = "\n        {\n            borrowAmounts(\n                ".concat(!filter.where ? "" : "where:".concat(JSON.stringify(filter.where).replace(/"(\w+)":/g, '$1:')), "\n                ").concat(!filter.skip ? "skip:0" : "skip: ".concat(filter.skip), "\n                ").concat(!filter.first ? "" : "first: ".concat(filter.first), "\n            ) {\n                amount\n                borrower\n                pairContract {\n                    pairContract\n                }\n            }\n        }\n        ");
            return _this._chains[fromChain].client.query(gql).then(function (rsp) { return rsp.borrowAmounts.map(function (borrowInfo) {
                return {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all(fromEtids.map(function (fromEtid) { return _this.selectExchangeHistory(fromEtid.chainIdentifier.toChainName(), __assign(__assign({}, filter), { orderBy: "time", orderDirection: "asc", where: {
                                        fromETID_: {
                                    ...
                                    return _this.selectExchangeHistory(pair.metaData.etid.chainIdentifier.toChainName(), {
         ...
         * @returns
         */
        this.getDepositedProof = function (history) { return _this.l3.createL3TransactionProof(history.from.chainIdentifier.toChainName(), history.id.split('-')[0], parseInt(history.id.split('-')[1]) - 1); };
        this.estimateFee = function (props) {
            ...
            return _this._chains[fromETID.chainIdentifier.toChainName()].router.methods.tokenExchangeToChainEstimateFee(fromETID, toETID, toAccount, amount).call().then(function (ret) {
                return {
        ...
        this.createBuidler = function (fromChain, fromAccount) {
            return new exchange_builder_1.ExchangeTransactionBuilder(_this, {
                fromChain: fromChain,
        ...
        this._chains = sdk_1.ChainNames.reduce(function (ret, key) {
            var c = props.chains[key];
            var web3 = new web3_1.default(c.provider);
            ret[key] = {
                web3: web3,
