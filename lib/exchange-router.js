...
var ExchangeRouter = /** @class */ (function () {
    ...
    function ExchangeRouter(l3, props) {
         ...
         * @returns
         */
        this.getSupportExchangePairs = function (fromChain) { return _this.metaDatas.filter(function (data) { return data.etid.chainIdentifier.toLowerCase() == sdk_1.ChainIdentifiers[fromChain].toLowerCase(); }).map(function (data) { return new exchange_pair_1.ExchangePair(_this._chains[fromChain].web3, data); }); };
        /**
         ...
         * @returns
         */
        this.createExchangeProof = function (history) { return _this.l3.createL3TransactionProof(history.from.chainIdentifier.toChainName(), history.id.split('-')[0], parseInt(history.id.split('-')[1]) - 1); };
        ...
        this.createExchangeBuilder = function (fromChain, fromAccount) {
