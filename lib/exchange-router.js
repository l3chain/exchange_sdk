...
var ExchangeRouter = /** @class */ (function () {
    function ExchangeRouter(props) {
         ...
         */
        this.fee = function (chainName) { return new Promise(function (resolve, reject) {
            _this._contracts.factory[chainName].methods
                .fee()
                .call()
                .catch(reject)
         ...
         * @returns rate 百分比
         */
        this.feeAdditionalOf = function (pair) { return new Promise(function (resolve) {
            _this._contracts.factory[(0, sdk_1.ChainNameFromIdentifier)(pair.metaData.etid.chainIdentifier)].methods
         ...
         * @returns
         */
        this.supportExchangePairs = function (fromChain) { return _this.metaDatas.filter(function (data) { return data.etid.chainIdentifier.toLowerCase() == sdk_1.ChainIdentifiers[fromChain].toLowerCase(); }).map(function (data) { return new exchange_pair_1.ExchangePair(_this._web3s[fromChain], data); }); };
        /**
         ...
         * @returns
         */
        this.wrappedCoinPair = function (onChain) { return __awaiter(_this, void 0, void 0, function () {
            var wcoinAddress, wcoinData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._contracts.router[onChain].methods.WCOIN().call()];
                    case 1:
                        wcoinAddress = _a.sent();
                        wcoinData = this.metaDatas.find(function (data) {
                            return data.etid.chainIdentifier.toLowerCase() == sdk_1.ChainIdentifiers[onChain].toLowerCase() &&
                                data.etid.tokenContract.toLowerCase() == wcoinAddress.toLowerCase();
                        });
                        if (!wcoinData) {
                            return [2 /*return*/, undefined];
                        }
                        return [2 /*return*/, new exchange_pair_1.ExchangePair(this._web3s[onChain], wcoinData)];
                }
            });
        }); };
        this.selectBorrowHistory = function (onChain, filter) { return __awaiter(_this, void 0, void 0, function () {
            var gql;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gql = "\n        {\n            borrowAmounts(\n                ".concat(!filter.where ? "" : "where:".concat(JSON.stringify(filter.where).replace(/"(\w+)":/g, '$1:')), "\n                ").concat(!filter.skip ? "skip:0" : "skip: ".concat(filter.skip), "\n                ").concat(!filter.first ? "" : "frist: ".concat(filter.first), "\n                ").concat(!filter.orderDirection ? "orderDirection:desc" : "orderDirection: ".concat(filter.orderDirection), "\n                ").concat(!filter.orderBy ? "orderBy:amount" : "orderBy: ".concat(filter.orderBy), "\n            ) {\n                amount\n                borrower\n            }\n        }\n        ");
                        return [4 /*yield*/, this._clients[onChain].query(gql).then(function (data) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ((_a = this._clients[fromChain]) === null || _a === void 0 ? void 0 : _a.query(gql).then(function (data) {
                                return data.exchangeds;
                            }))];
                    case 1:
                        exchangeds = _b.sent();
                        emitChainIdentifier = sdk_1.ChainIdentifiers[fromChain];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, this.selectExchangeHistory((0, sdk_1.ChainNameFromIdentifier)(history.to.chainIdentifier), {
                            first: 1,
                            where: {
         ...
         * @param account
         */
        this.getBorrowAmountsOf = function (fromChain, filter) {
            var gql = "\n        {\n            borrowAmounts(\n                ".concat(!filter.where ? "" : "where:".concat(JSON.stringify(filter.where).replace(/"(\w+)":/g, '$1:')), "\n                ").concat(!filter.skip ? "skip:0" : "skip: ".concat(filter.skip), "\n                ").concat(!filter.first ? "" : "frist: ".concat(filter.first), "\n            ) {\n                amount\n                borrower\n                pairContract {\n                    pairContract\n                }\n            }\n        }\n        ");
            return _this._clients[fromChain].query(gql).then(function (rsp) { return rsp.borrowAmounts.map(function (borrowInfo) {
                return {
                    amount: (0, web3_utils_1.toBN)(borrowInfo.amount),
                    borrower: borrowInfo.borrower,
                    exchangePair: new exchange_pair_1.ExchangePair(_this._web3s[fromChain], _this.metaDatas.find(function (value) {
                        return value.etid.chainIdentifier.toLowerCase() == sdk_1.ChainIdentifiers[fromChain].toLowerCase() &&
         ...
         * @param pair
         */
        this.selectBadExchange = function (pair) { return __awaiter(_this, void 0, void 0, function () {
            var fromEtids, allHistory;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fromEtids = pair.fromExchangeTokenIds;
                        return [4 /*yield*/, Promise.all(fromEtids.map(function (fromEtid) { return _this.selectExchangeHistory((0, sdk_1.ChainNameFromIdentifier)(fromEtid.chainIdentifier), {
                                first: 100,
                                orderBy: "time",
                                orderDirection: "asc",
                                where: {
                                ...
                                return _this.selectExchangeHistory((0, sdk_1.ChainNameFromIdentifier)(pair.metaData.etid.chainIdentifier), {
                    ...
                    case 1:
                        allHistory = _a.sent();
                        return [2 /*return*/, allHistory.flat()];
                }
            });
        }); };
        /**
         ...
         * @returns
         */
        this.getDepositedProof = function (history) { return _this._l3chain.createL3TransactionProof((0, sdk_1.ChainNameFromIdentifier)(history.from.chainIdentifier), history.id.split('-')[0], parseInt(history.id.split('-')[1]) - 1); };
        var generatedDatas = props.generatedDatas, graphQL = props.graphQL, providers = props.providers, addresses = props.addresses, l3chain = props.l3chain;
        ...
        for (var _i = 0, ChainNames_1 = sdk_1.ChainNames; _i < ChainNames_1.length; _i++) {
            ...
            this._clients[name_1] = new sdk_1.GraphQlClient(graphQL[name_1]);
            this._web3s[name_1] = new web3_1.default(providers[name_1]);
            this._contracts.factory[name_1] = new this._web3s[name_1].eth.Contract(abi_1.ABI.Factory, addresses.factory[name_1]);
            this._contracts.router[name_1] = new this._web3s[name_1].eth.Contract(abi_1.ABI.Router, addresses.router[name_1]);
        }
    }
    Object.defineProperty(ExchangeRouter.prototype, "contractAddress", {
        get: function () {
