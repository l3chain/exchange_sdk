...
function ExchangePairsGenerater(providerGroup) {
    return __awaiter(this, void 0, void 0, function () {
        var graphURL, chainNameFromIdentifier, getExchangePairs, paris, _loop_1, _i, _a, name_1, _loop_2, _b, _c, key;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    graphURL = Object.keys(providerGroup.providers).reduce(function (ret, key) {
                        ret[key] = providerGroup.providers[key].graphURL;
                        return ret;
                    }, {});
                    chainNameFromIdentifier = Object.keys(providerGroup.providers).reduce(function (ret, key) {
                        ret[providerGroup.providers[key].chainIdentifier.toLowerCase()] = key;
                        return ret;
                    }, {});
                    getExchangePairs = function (chainName) { return new Promise(function (resolve, reject) {
                    ...
                    _i = 0, _a = Object.values(chainNameFromIdentifier);
                    _d.label = 1;
                case 1:
                ...
                case 4:
                    _loop_2 = function (key) {
                        ...
                        pair.fromEtid.forEach(function (etid) {
                            paris["".concat(chainNameFromIdentifier[etid.chainIdentifier.toLowerCase()], "-").concat(etid.shadowEmiter).toLowerCase()].toEtid.push(pair.etid);
                        });
                    };
